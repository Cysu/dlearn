...
class Dataset(object):
    ...
    def split(self, train_ratio, valid_ratio):
        ...
        self.train_x = create_shared(self.X[self.train_ind, :])
        self.train_y = create_shared(self.Y[self.train_ind, :])
        self.valid_x = create_shared(self.X[self.valid_ind, :])
        self.valid_y = create_shared(self.Y[self.valid_ind, :])
        self.test_x = create_shared(self.X[self.test_ind, :])
        self.test_y = create_shared(self.Y[self.test_ind, :])
